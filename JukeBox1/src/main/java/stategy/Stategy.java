...
public class Stategy {
    ...
    public void random(ArrayList list) throws PlayerException {
    ...
    public void order(ArrayList<InputStream> list) throws PlayerException {
    ...
    public  void loop(ArrayList<InputStream> list) throws PlayerException {
        InputStream s = null;
        Player p = PlayerFactory.getPlayer();
        for (int i = 0; i < list.size(); i++) {
//            
            s = (InputStream) list.get(i);
